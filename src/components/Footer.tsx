        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/about" className="text-gray-600 hover:text-orange transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-600 hover:text-orange transition-colors">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/products?category=birthday" className="text-gray-600 hover:text-orange transition-colors">
                  Birthday Cakes
                </Link>
              </li>
              <li>
                <Link to="/products?category=wedding" className="text-gray-600 hover:text-orange transition-colors">
                  Wedding Cakes
                </Link>
              </li>
              <li>
                <Link to="/products?category=special" className="text-gray-600 hover:text-orange transition-colors">
                  Special Occasion
                </Link>
              </li>
              <li>
                <Link to="/products?category=cupcakes" className="text-gray-600 hover:text-orange transition-colors">
                  Cupcakes
                </Link>
              </li>
            </ul>
